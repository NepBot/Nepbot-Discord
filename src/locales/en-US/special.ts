...
export default {
  ...
  'fail.title.twitter_verify': 'Twitter is connected, but ... ',
  'fail.title.airdrop': 'Oops!',
  'fail.description.airdrop':
    'Something went wrong. Please try again. {support}',
  'fail.title.default': 'Oops!',
  'fail.description.default': 'Something went wrong. {support}',
  'nodata.text': 'No data, please add a new {name}.',
};
