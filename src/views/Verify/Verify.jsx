...
export default function Index(props) {
    ...
    function Login() {
        ...
        if (!accountId) {
            return <div>
                <div className={'tip'}>Connect with</div>
                <div className={'connect-btn'} onClick={() => {handleConnect(("near"))}}>Near Wallet</div>
                <div className={'connect-btn'} onClick={() => {handleConnect(("sender"))}}>Sender Wallet</div>
                <div className={'tip'}>Connect to your wallet</div>
            </div>
        } else {
            return <div>
            <div className={'server-name'}>{accountId}</div>
            <div className={'connect-btn'} onClick={handleDisconnect}>Disconnect</div>
        </div>
        }
